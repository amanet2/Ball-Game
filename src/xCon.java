...
//        ProcessBuilder pb = new ProcessBuilder("../bin/python-3.11.5-embed-amd64/python", "../python/test.py").redirectOutput(ProcessBuilder.Redirect.INHERIT);  //windows for debug

#export PATH="$(cd $(dirname "$1");pwd)"/../bin/jdk-18.jdk/Contents/Home/bin/:${PATH}
...
"$(cd $(dirname "$1");pwd)"/../bin/jdk-18.jdk/Contents/Home/bin/jar cmf MANIFEST.MF BALL_GAME.jar *.class
rm *.class
cd "$(cd $(dirname "$1");pwd)"

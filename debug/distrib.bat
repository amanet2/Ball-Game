...
set java_prefix=runtime\jdk-23.0.2
set java_dir=%home_dir%\%java_prefix%
set echo_c_script=%home_dir%\debug\echo_c.bat
set echo_c_start_str="start ..\\runtime\\jdk-23.0.2\\bin\\javaw -Dsun.java2d.uiScale=1.0 -Dsun.java2d.opengl=true -jar BALL_GAME.jar "
set echo_c_start_str_mapmaker="start ..\\runtime\\jdk-23.0.2\\bin\\javaw -Dsun.java2d.uiScale=1.0 -Dsun.java2d.opengl=true -jar BALL_GAME.jar showmapmakerui 1 "
set echo_c_outfile=%tmp_dir%\ballplayer.c
set echo_c_outfile_mapmaker=%tmp_dir%\ballmapper.c
set gcc_exe=C:\mingw64\bin\gcc.exe
set game_exe=%tmp_dir%\ballplayer.exe
set game_editor_exe=%tmp_dir%\ballmapper.exe
